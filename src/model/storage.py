...
# from season import util.std.stdClass
...
class Model:
    ...
    def basepath(self):
        ...
        return os.path.join(self.config.get("path", os.path.join("/var/www/kmbig_admin", "storage")), self.namespace)
